# Pruebas basadas en especificaciones <!-- omit in toc -->

- [Los requisitos lo dicen todo](#los-requisitos-lo-dicen-todo)
- [Paso 1: Comprensión de los requisitos, entradas y salidas](#paso-1-comprensión-de-los-requisitos-entradas-y-salidas)
- [Paso 2: Explora lo que hace el programa para varias entradas](#paso-2-explora-lo-que-hace-el-programa-para-varias-entradas)
- [Paso 3: Explore las posibles entradas y salidas, e identifique las particiones](#paso-3-explore-las-posibles-entradas-y-salidas-e-identifique-las-particiones)
- [Paso 4: Analiza los límites](#paso-4-analiza-los-límites)
- [Paso 5: Idear casos de prueba](#paso-5-idear-casos-de-prueba)
- [Paso 6: Automatice los casos de prueba](#paso-6-automatice-los-casos-de-prueba)
- [Paso 7: Aumenta el conjunto de pruebas con creatividad y experiencia](#paso-7-aumenta-el-conjunto-de-pruebas-con-creatividad-y-experiencia)
