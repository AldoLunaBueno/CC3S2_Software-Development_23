# Pruebas en software - parte2 <!-- omit in toc -->

- [Pruebas de caja negra y caja de cristal](#pruebas-de-caja-negra-y-caja-de-cristal)
- [Pruebas unitarias y de integración](#pruebas-unitarias-y-de-integración)
- [Pruebas de regresión automatizadas](#pruebas-de-regresión-automatizadas)
- [Test First Development](#test-first-development)
  - [Plan de iteración:](#plan-de-iteración)
- [Documenta tu estrategia de prueba](#documenta-tu-estrategia-de-prueba)
